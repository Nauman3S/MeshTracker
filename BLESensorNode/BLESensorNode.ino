...
void setup() {
  ...
  TrackerID=StringSeparator(TrackerID,':',0)+StringSeparator(TrackerID,':',1)+StringSeparator(TrackerID,':',2)
            +StringSeparator(TrackerID,':',3)+
...
void sendMessage() {
  String msg = "From TrackerID: "+TrackerID+String("__");
  msg += mesh.getNodeId();
